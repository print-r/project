...
export const commonHeaderStyle = {
    mobile: {
        theme: {
            1: {
                backgroundImage: require('../../../assets/images/theme/bg_a_s.png'),
            },
            2: {
                backgroundImage: require('../../../assets/images/theme/bg_b.png'),
                addedClass: 'defalutThemeStyle',
            },
            3: {
                backgroundImage: require('../../../assets/images/theme/bg_c_s.png'),
            },
            4: {
                backgroundImage: require('../../../assets/images/theme/bg_d_s.png'),
            },
            5: {
                backgroundImage: require('../../../assets/images/theme/bg_g_s.png'),
            },
            6: {
                backgroundImage: require('../../../assets/images/theme/bg_h_s.png'),
            },
            7: {
                backgroundImage: require('../../../assets/images/theme/bg_e_s.png'),
            },
            8: {
                backgroundImage: require('../../../assets/images/theme/bg_f_s.png'),
            },
        },
    },
    pc: {
